...
import { deleteNewsLetter , getNewsLetter , newEvent , getAllEvents , getAllParticipants } from "../controllers/adminController.js";
...
adminRouter.get("/event/participants/all" , getAllParticipants );
